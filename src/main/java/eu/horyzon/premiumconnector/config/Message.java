...
public enum Message {
	PREFIX("prefix", "&8[&6PremiumConnector&8]&r"), MYSQL_ERROR("mySQLError", "&cDatabase error!\r\n&cPlease retry later or contact an administrator"), NOT_PREMIUM_ERROR("notPremiumError", "&2You're not the owner of this account\r\n&2Please change your username to join our server!"), MOJANG_SERVER_ERROR("mojangServerError", "&cAuthentification error\r\n&cMojang's servers are currently down, please retry later!"), RATE_LIMIT("rateLimit", "&cAuthentification overload\r\n&cAuthentificate process is currently overload. Please retry in one minute"), WRONG_EDITION("wrongEdition", "&c       Wrong edition\r\n&cPlease join with your right Minecraft edition"), CONSOLE_COMMAND("consoleCommand", "%prefix% &cPlease use /%cmd% [player]"), NO_PERMISSION("noPermission", "%prefix% &cYou don't have the permission to do this."), NO_PLAYER("noPlayer", "%prefix% &cPlayer %player% not found."), ALREADY_DEFINED("alreadyDefined", "%prefix% &cYou are already defined as &6&l%status%&c."), ALREADY_DEFINED_OTHER("alreadyDefinedOther", "%prefix% &c%player% is already defined as &6&l%status%&c."), WARN_COMMAND("warnCommand", "%prefix% &c&lWARNING &6This command should &lonly &6be invoked if you are the owner of this paid minecraft account. Type &a/%cmd% &6command again to confirm."), SUCCESS_COMMAND("successCommand", "%prefix% &6You are now &l%status%&6, you needs to reconnect you to the server to apply changes."), FAIL_COMMAND("failCommand", "%prefix% &cYou are already a &6&l%status% &cuser."), SUCCESS_COMMAND_OTHER("successCommandOther", "%prefix% &6Player %player% is now &l%status%&6, he needs to reconnect to the server to apply changes."), FAIL_COMMAND_OTHER("failCommandOther", "%prefix% &cPlayer %player% is already a &6&l%status% &cuser."), ERROR_COMMAND("errorCommand", "&c%prefix% Error on executing this command. Please try again later or contact an administrator."), CRACKED_STATUS("crackedStatus", "Cracked"), PREMIUM_STATUS("premiumStatus", "Premium"), NO_STATUS("noStatus", "Not defined");
